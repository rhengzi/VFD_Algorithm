...
bool MyVF2State::IsFeasiblePair(node_id node1, node_id node2)
  { assert(node1<n1);
    ...
    int i, other1, other2;
    void *attr1;
    int termout1=0, termout2=0, termin1=0, termin2=0, termout1in=0, termout2in=0, termin1in=0, termin2in=0;
	
	//if(g1->OutEdgeCount(node1)!=g2->OutEdgeCount(node2) || g1->InEdgeCount(node1)!=g2->InEdgeCount(node2))
	//	return false;
    int out1,out2,in1,in2;
    out1 = g1->OutEdgeCount(node1);
    out2 = g2->OutEdgeCount(node2);
    in1 = g1->InEdgeCount(node1);
    in2 = g2->InEdgeCount(node2);
    ...
    return  termin1==termin2 && termout1==termout2 && termout1in==termout2in &&termin1in==termin2in;
  }
